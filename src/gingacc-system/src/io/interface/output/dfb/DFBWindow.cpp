...
namespace io {
	...
	void DFBWindow::draw() {
		if (win != NULL) {
			...
			DFBCHECK(win->SetOpacity(win, 0xFF));
	...
	void DFBWindow::setBackgroundColor(int r, int g, int b, int alpha) {
		...
		if (winSur != NULL) {
			...
			if (r < 0 || g < 0 || b < 0) {
				...
				DFBCHECK(winSur->SetColor(winSur, DFBSurface::DFB_BG_R, DFBSurface::DFB_BG_G, DFBSurface::DFB_BG_B, DFBSurface::DFB_BG_A));
				DFBCHECK(winSur->Clear(winSur, DFBSurface::DFB_BG_R, DFBSurface::DFB_BG_G, DFBSurface::DFB_BG_B, DFBSurface::DFB_BG_A));
