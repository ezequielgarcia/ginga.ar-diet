...
#include "../../../../../include/io/interface/content/text/DFBFontProvider.h"
...
namespace io {
	...
	void DFBFontProvider::playOver(void* surface, const char* text, int x, int y, short align) {

		IDirectFBSurface* s;
		s = (IDirectFBSurface*)(((ISurface*)surface)->getContent());
		_DFBSurfaceMutexSingleton.instance().lock();
		DFBCHECK(s->DrawString(s, text, -1, x, y, (DFBSurfaceTextFlags)(align)));
