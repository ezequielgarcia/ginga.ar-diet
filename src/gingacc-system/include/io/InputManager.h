...
namespace io {
	class InputManager : public IInputManager, public Thread {
		private:
			...
			connector::KeyEventHandler *keyHandler;
			connector::Connector       *connector;
			
			std::multiset<int> globalKeys;
		...
		public:
			...
			void removeInputEventListener(IInputEventListener* listener, bool report);

			void reportKeysToConnector(bool isReserve, std::set<int> *keys);
		private:
		...
		public:
			...
			void setConnector(connector::Connector *c);
