...
namespace io {
	class IImageProvider : IIOContainer {
		public:
			...
			virtual ISurface* renderImage()=0;
			virtual ISurface* renderImage(string mrl)=0;
			virtual void renderImage(string mrl, ISurface* surface)=0;
	};
}
}
}
...
typedef ::br::pucrio::telemidia::ginga::core::system::io::IImageProvider*
