...
namespace model {
namespace time {
	class LinearCostFunctionDuration : public CostFunctionDuration {
		public:
			LinearCostFunctionDuration(
				double expectedVal,
				double minVal,
				double maxVal,
			...
			virtual ~LinearCostFunctionDuration(){};
...
#endif //_LINEARCOSTFUNCTIONDURATION_H_
