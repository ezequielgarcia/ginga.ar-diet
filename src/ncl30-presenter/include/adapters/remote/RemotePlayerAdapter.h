...
#ifndef _RemotePlayerAdapter_H_
#define _RemotePlayerAdapter_H_
...
namespace adapters {
namespace remote {
	class RemotePlayerAdapter : public FormatterPlayerAdapter {
		private:
