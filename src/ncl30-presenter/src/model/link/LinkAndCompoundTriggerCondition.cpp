...
http://www.telemidia.puc-rio.br
*******************************************************************************/
#include "../../../include/model/LinkAndCompoundTriggerCondition.h"
...
namespace link {
	LinkAndCompoundTriggerCondition::LinkAndCompoundTriggerCondition() :
		...
		unsatisfiedConditions = new vector<LinkCondition*>;
		statements = new vector<LinkCondition*>;
	...
	void LinkAndCompoundTriggerCondition::addCondition(
		...
		if (condition->instanceOf("LinkTriggerCondition")) {
			...
			cout << "LinkAndCompoundTriggerCondition::";
			cout << "addCondition Warning! statements ";
			cout << "trying to add a condition !instanceOf(LinkStatement)";
			cout << " and !instanceOf(LinkTriggerCondition)";
			cout << endl;
		}
	}
