...
#include "../../../include/model/LinkCompoundTriggerCondition.h"
...
namespace link {
	LinkCompoundTriggerCondition::LinkCompoundTriggerCondition() :
		...
		conditions = new vector<LinkCondition*>;
	...
	vector<LinkCondition*>* LinkCompoundTriggerCondition::getConditions() {
		if (conditions->begin() == conditions->end())
			return NULL;
	...
	void LinkCompoundTriggerCondition::conditionSatisfied(void *condition) {
		...
		LinkTriggerCondition::conditionSatisfied(
