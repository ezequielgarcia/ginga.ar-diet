...
namespace link {
	LinkTransitionTriggerCondition::LinkTransitionTriggerCondition(
		...
		if (event != NULL) {
			...
			cout << "LinkTransitionTriggerCondition::";
			cout << "LinkTransitionTriggerCondition Warning! ";
			cout << "creating a link with NULL event" << endl;
		}
	}
	...
	void LinkTransitionTriggerCondition::eventStateChanged(
		...
		cout << "LinkTransitionTriggerCondition::eventStateChanged ";
		cout << "from object '" << obj->getId();
