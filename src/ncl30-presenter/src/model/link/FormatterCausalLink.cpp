...
namespace link {
    ...
    void FormatterCausalLink::conditionSatisfied(void* condition) {
    	LinkTriggerCondition* linkCondition;

		/*cout << endl;
		cout << "FormatterCausalLink::conditionSatisfied(" << ncmLink->getId();
		cout << ") starting action(s)" << endl << endl;*/

    	linkCondition = (LinkTriggerCondition*)condition;
    	action->start();
    }
    ...
    void FormatterCausalLink::evaluationStarted() {
		/*cout << endl;
		cout << "FormatterCausalLink::evaluationStarted(" << ncmLink->getId();
		cout << ")" << endl << endl;*/
	...
	void FormatterCausalLink::evaluationEnded() {
		/*cout << endl;
		cout << "FormatterCausalLink::evaluationEnded(" << ncmLink->getId();
		cout << ")" << endl << endl;*/
	...
	void FormatterCausalLink::actionProcessed(bool start) {
		/*cout << endl;
		cout << "FormatterCausalLink::actionProcessed(";
		if (!start) {
			cout << "start:" << ncmLink->getId();
		} else {
			cout << "nostart:" << ncmLink->getId();
		}
		cout << ")" << endl << endl;*/
		((CompositeExecutionObject*)parentObject)->
