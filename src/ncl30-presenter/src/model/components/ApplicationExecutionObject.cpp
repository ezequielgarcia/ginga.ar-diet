...
namespace components {
	...
	ApplicationExecutionObject::ApplicationExecutionObject(
			...
			bool handling) : ExecutionObject(id, node, descriptor, handling) {
	...
	bool ApplicationExecutionObject::stop() {
		...
		//cout << "ApplicationExecutionObject::stop(" << id << ")" << endl;
	...
	bool ApplicationExecutionObject::unprepare() {
		//cout << "ApplicationExecutionObject::unprepare(" << id << ")" << endl;
