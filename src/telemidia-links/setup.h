...
#define G_BFU_DEFAULT_FONT_SIZE		0
#define G_DEFAULT_BFU_FG_COLOR		0x000000
#define G_DEFAULT_BFU_BG_COLOR		(getenv("USER") && (!strcasecmp(getenv("USER"), "mikulas") || !strcasecmp(getenv("USER"), "mpat7421")) ? 0xffffff : 0xffffff)

#define G_MENU_LEFT_BORDER		0
#define G_MENU_LEFT_INNER_BORDER	0
#define G_MENU_TOP_BORDER		0
#define G_MENU_HOTKEY_SPACE		0
#define G_MAINMENU_LEFT_BORDER		0
#define G_MAINMENU_BORDER		0

#define G_DIALOG_TITLE_BORDER		0
#define G_DIALOG_LEFT_BORDER		0
#define G_DIALOG_TOP_BORDER		0
#define G_DIALOG_HLINE_SPACE		0
#define G_DIALOG_VLINE_SPACE		0
#define G_DIALOG_LEFT_INNER_BORDER	0
#define G_DIALOG_TOP_INNER_BORDER	(G_BFU_FONT_SIZE < 24 ? 8 : G_BFU_FONT_SIZE - 16)

#define G_DIALOG_BUTTON_SPACE		0
#define G_DIALOG_CHECKBOX_SPACE		0

#define G_DIALOG_GROUP_SPACE		0
#define G_DIALOG_GROUP_TEXT_SPACE	0
...
#define G_SCROLL_BAR_WIDTH		0
#define G_SCROLL_BAR_MIN_SIZE		0
...
#define G_HTML_TABLE_FRAME_COLOR	0x00
...
#define HTML_CHAR_WIDTH			4
#define HTML_CHAR_HEIGHT		7
#define HTML_FRAME_CHAR_WIDTH		6
#define HTML_FRAME_CHAR_HEIGHT		9
#define HTML_TABLE_2ND_PASS
#define HTML_DEFAULT_INPUT_SIZE		10
