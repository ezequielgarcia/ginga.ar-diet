...
unsigned char *links_convert_string(struct conv_table *ct, unsigned char *c, int l, struct document_options *dopt)
{
...
unsigned char *to_utf8_upcase(unsigned char *str, int cp)
{
	...
	str1 = links_convert_string(ct, str, strlen(str), NULL);
