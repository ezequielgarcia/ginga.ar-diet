...
public:
	...
	virtual SSIZE_T read( SSIZE_T off, BYTE *buf, SIZE_T len )=0;
	virtual SSIZE_T sendFile( FILE *of, SSIZE_T o_off, SSIZE_T i_off, SIZE_T len )=0;	
	virtual SSIZE_T write( SSIZE_T off, BYTE *buf, SIZE_T len )=0;
