...
#ifndef CIRCLESPATIALANCHOR_H_
#define CIRCLESPATIALANCHOR_H_
...
namespace interfaces {
	class CircleSpatialAnchor : public SpatialAnchor {
		private:
			/**
			...
			*/
			...
			/**
			* The radius of the circle centre.
			*/
			long radius;
		...
		public:
			...
			* @param radius radius of the circle centre.
			*/
