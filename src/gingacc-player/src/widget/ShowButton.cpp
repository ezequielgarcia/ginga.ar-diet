	...
	void ShowButton::run() {
		...
		switch (status) {
			case PAUSE:
				...
				render(DATA_PREFIX_PATH "/share/ginga/img/button/pauseButton.png");
				break;
			...
			case STOP:
				...
				render(DATA_PREFIX_PATH "/share/ginga/img/button/stopButton.png");
				::usleep(1000000);
				release();
				break;
			...
			case PLAY:
				...
				render(DATA_PREFIX_PATH "/share/ginga/img/button/playButton.png");
				::usleep(1000000);
				release();
				break;
