...
namespace player {
	class INCLPlayer : public IPlayer {
		public:
			...
			//Editing commands
			virtual bool editingCommand(
				::br::pucrio::telemidia::ginga::ncl::StopDocumentEC* ec)=0;
			virtual bool editingCommand(
				::br::pucrio::telemidia::ginga::ncl::StartDocumentEC* ec)=0;
			virtual bool editingCommand(
				::br::pucrio::telemidia::ginga::ncl::AddLinkEC* ec)=0;
			virtual bool editingCommand(
				::br::pucrio::telemidia::ginga::ncl::SetPropertyValueEC* ec)=0;
			virtual bool editingCommand(
				::br::pucrio::telemidia::ginga::ncl::AddNodeEC* ec)=0;
			virtual bool editingCommand(
				::br::pucrio::telemidia::ginga::ncl::AddInterfaceEC* ec)=0;
